module Harness
  module Turn
    ...
    module Parts
      ...
      # organ's own prose). Attribution headers were tried 2026-08-14 and
      # removed same day by ruling — too mechanical, shows the theatre's
      # rigging; the prose's own beat carries the who. Other committed
      # events show whole when short and personal; anything longer is a
      # record, not display.
